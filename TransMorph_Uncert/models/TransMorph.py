...
class TransMorph3lvl(nn.Module):
    def __init__(self, config):
        '''
        TransMorph Model
        '''
        super(TransMorph3lvl, self).__init__()
...
class TransMorphTVF(nn.Module):
    def __init__(self, config, time_steps=7, SVF=False):
        ...
        2. Chen, Junyu, Eric C. Frey, and Yong Du.
        "Unsupervised learning of diffeomorphic image registration via transmorph."
        International Workshop on Biomedical Image Registration. Cham: Springer International Publishing, 2022.
        '''
